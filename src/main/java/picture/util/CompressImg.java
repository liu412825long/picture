...
public class CompressImg {
    ...
    public CompressImg(String fileName) throws IOException {
        File _file = new File(fileName); // 读入文件
        _file.getName();

        this.destFile = "D:/pic/22.jpg";// this.srcFile.substring(0,
    ...
    public static void main(String[] args) {
        ...
        try {
            CompressImg ccc = new CompressImg("D:\\source\\1.jpg");
//            ccc.resize(1);
